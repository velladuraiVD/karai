        ...
        <div className='m-4 flex flex-col flex-wrap'>
            <form action="">
                <div className='mt-4 '>
                    ...
                    <input type='email' id='email' placeholder='name@flowbite.com' className=' p-2  bg-gray-50 border-2 focus:outline-none text-base font-semibold rounded-lg w-auto  md:w-[700px] h-[40px]'></input>
                </div>
                <div className='mt-4'>
                <label for="subject" className='block mb-2 text-xl font-bold text-[#FFFFFF]'>Subject</label>
                <input type='message' id='subject' placeholder='Let us know how we can help you '  className=' p-2 shadow-sm bg-gray-50 border  border-gray-300 focus:outline-none text-base font-semibold rounded-lg sm:w-auto md:w-[700px] h-[40px] '></input>
                </div>
                <div className='mt-4'>
                <label for="message" className='block mb-2 text-xl font-bold text-[#FFFFFF]'>Your Message</label>
                <textarea id='mesage' rows="2" placeholder='Leave a comment...' className=' p-2 shadow-sm bg-gray-50 border border-gray-300 focus:outline-none text-base font-semibold rounded-lg w-auto md:w-full'></textarea>
                </div>
            </form>
